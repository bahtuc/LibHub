    ...
    */
    ...
    VALUES
        ...
        (N'O chuột', '9786040001962', 2021, N'Tập truyện của Tô Hoài khắc họa sinh động thế giới loài vật và đời sống thôn quê bằng giọng kể hóm hỉnh, giàu quan sát.', NULL, N'Tiếng Việt', 292, (SELECT category_id FROM Categories WHERE category_name = N'Văn học Việt Nam'), (SELECT author_id FROM Authors WHERE author_name = N'Tô Hoài'), (SELECT publisher_id FROM Publishers WHERE publisher_name = N'NXB Kim Đồng'), 0, 0),
